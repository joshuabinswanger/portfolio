...
filter/sort UI, video playback, image handling, content YAML, or head
metadata/SEO, read the matching file: [galleries](docs/galleries.md),
...
[seo](docs/seo.md), [troubleshooting](docs/troubleshooting.md).
